...
$app->get("/order/:idorder", function($idorder){
	...
	$page->setTpl("payment",array('order' => $order->getValues()));
});
...
$app->get("/profile/orders", function(){
	...
	$page->setTpl("profile-orders",$data);
});
...
$app->get("/profile/orders/:idorder", function($idorder){
	...
	$page->setTpl("profile-orders-detail",$data);
});
...
$app->get("/profile/change-password", function(){
	...
	$page->setTpl("profile-change-password",$data);
});
...
$app->post("/profile/change-password", function(){
	...
	{
		User::setError("A senha e a confirmação devem ser iguais.");
		header("Location: /profile/change-password");
		exit;
	}
	...
	{
		User::setError("A senha inválida.");
		header("Location: /profile/change-password");
		exit;
	}
