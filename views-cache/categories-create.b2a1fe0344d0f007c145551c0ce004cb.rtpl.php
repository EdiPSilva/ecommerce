    ...
    <section class="content-header">
        ...
        <div class="col-md-8">
            <ol class="breadcrumb">
                ...
                <li class="active"><a href="/admin/categories/create"><i class="fa fa-plus"></i>&nbsp;<?php echo htmlspecialchars( $category_title_register, ENT_COMPAT, 'UTF-8', FALSE ); ?></a></li>
            </ol>
        </div>
    </section>
            ...
            <div class="col-md-12">
                <div class="box box-success">
                    <div class="box-header with-border">
                        <div class="col-md-12">
                            <h3 class="box-title"><?php echo htmlspecialchars( $category_title_register, ENT_COMPAT, 'UTF-8', FALSE ); ?></h3>
                        </div>
                    </div>
                        ...
                        <div class="box-body">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="descategory" name="descategory" placeholder="<?php echo htmlspecialchars( $category_input_name, ENT_COMPAT, 'UTF-8', FALSE ); ?>">
                                </div>
                            </div>
                        </div>
