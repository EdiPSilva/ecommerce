            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header">
                        ...
                        <div class="col-sm-2">
                            <a href="/admin/categories/create" class="btn btn-success btn-block pull-right">
                                <i class="fa fa-plus"></i>&nbsp;<?php echo htmlspecialchars( $category_button_create, ENT_COMPAT, 'UTF-8', FALSE ); ?>
                            </a>
                        </div>
                    </div>
                                ...
                                <tbody>
                                    <?php $counter1=-1;  if( isset($categories) && ( is_array($categories) || $categories instanceof Traversable ) && sizeof($categories) ) foreach( $categories as $key1 => $value1 ){ $counter1++; ?>
                                        <tr>
                                            ...
                                            <td class="col-sm-3">
                                                <div class="col-sm-4">
                                                    <a href="/admin/categories/<?php echo htmlspecialchars( $value1["idcategory"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/products" class="btn btn-default btn-xs"><i class="fa fa-edit"></i>&nbsp;<?php echo htmlspecialchars( $category_button_action_product, ENT_COMPAT, 'UTF-8', FALSE ); ?></a>
                                                </div>
                                                <div class="col-sm-4">
